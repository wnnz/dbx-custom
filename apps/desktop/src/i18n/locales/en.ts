export default {
  ...
  connection: {
    ...
    currentWindowsUser: "Leave blank to use current Windows user",
    currentWindowsUserPassword: "Leave blank to use current Windows user",
    next: "Next",
    back: "Previous",
    basicTab: "Connection",
    tlsTab: "TLS/SSL",
  ...
  tabs: {
    ...
    resultHistory: "Execution History",
  ...
  contextMenu: {
    ...
    entityCodeTitle: "Entity Code - {name}",
    entityCodeTitleMultiple: "Entity Code - {count} objects",
    entityCodeLanguage: "Language",
    entityCodeOrm: "ORM",
    entityCodeLoading: "Generating entity code...",
    entityCodeCopied: "Entity code copied",
    copyEntityCode: "Copy Code",
    saveEntityCode: "Save Code",
