export default {
  ...
  connection: {
    ...
    authMethod: "认证方式",
    sqlServerAuth: "SQL Server 登录",
    windowsAuth: "Windows 登录",
    windowsUser: "Windows 用户",
    currentWindowsUser: "留空使用当前 Windows 用户",
    currentWindowsUserPassword: "留空使用当前 Windows 用户",
    next: "下一步",
    back: "上一步",
    basicTab: "连接信息",
    tlsTab: "TLS/SSL",
  ...
  contextMenu: {
    ...
    generateEntityCode: "生成实体代码",
    entityCodeTitle: "实体代码 - {name}",
    entityCodeTitleMultiple: "实体代码 - {count} 个对象",
    entityCodeLanguage: "语言",
    entityCodeOrm: "ORM 库",
    entityCodeLoading: "正在生成实体代码...",
    entityCodeCopied: "实体代码已复制",
    copyEntityCode: "复制代码",
    saveEntityCode: "保存代码",
    createTable: "新建表",
    createView: "新建视图",
